...
An attempt at mixing two heavy weight projects:

* BizHawk: For TASing tools and waterboxing
* SDLPoP: For Prince of Persia 1 Emulation

# Original BizHawk Readme Follows
